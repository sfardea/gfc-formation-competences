            ...
            <div class="legal-page mentions-legales">
                <section class="page-hero">
                    <div class="container">
                        ...
                        <p class="hero-subtitle">Informations légales et réglementaires</p>
                    </div>
                </section>
                ...
                <section class="legal-content">
                    <div class="container">
                        <div class="content-wrapper">
                            ...
                            <p>
                                <strong>Dénomination sociale :</strong> GROUPE FORMATION COMPETENCES<br><br>
                                <strong>Forme juridique :</strong> SASU, société par actions simplifiée unipersonnelle<br><br>
                                <strong>Capital social :</strong> 500,00 €<br><br>
                                <strong>Siège social :</strong> 16 RUE CUVIER, 69006 LYON<br><br>
                                <strong>Date de création :</strong> 09/08/2022<br><br>
                                <strong>SIREN :</strong> 918 325 796<br><br>
                            ...
                            <p>
                                ...
                                fichiers et aux libertés, vous disposez d'un droit d'accès, de rectification, 
                                de suppression et d'opposition aux données personnelles vous concernant.
                            </p>
                            <p>
                                <strong>Responsable du traitement :</strong> Groupe Formation Compétences<br><br>
                                <strong>Finalité du traitement :</strong> Gestion des demandes de contact et d'information<br><br>
                                <strong>Base légale :</strong> Consentement de la personne concernée
                            </p>
                            <p>
                                Pour exercer vos droits, vous pouvez nous contacter à l'adresse suivante : 
                                <a href="mailto:dpo@groupe-formation-competences.fr">dpo@groupe-formation-competences.fr</a>
                            </p>
                            ...
                            <p>
                                ...
                                nous permettent de reconnaître votre navigateur et de mémoriser certaines informations.
                            </p>
                            ...
                            <p>
                                ...
                                mais cela peut affecter votre expérience de navigation.
                            </p>
                            ...
                            <p>
                                ...
                                <a href="mailto:contact@groupe-formation-competences.fr">contact@groupe-formation-competences.fr</a>, 
                                en décrivant le problème de la manière la plus précise possible.
                            </p>
                            <p>
                                Groupe Formation Compétences ne saurait être tenu pour responsable de 
